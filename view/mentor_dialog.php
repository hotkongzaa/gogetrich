<div class="modal fade mentor-p_kieak" tabindex="-1" role="dialog">
    <div class="tg-signup-modalbox">
        <h2>MENTOR DETAIl <span class="pull-right" style="cursor: pointer" onclick="$('.mentor-p_kieak').modal('hide')">x</span></h2>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8" style="overflow-x:hidden; max-height: 450px;">
                        <fieldset>
                            ...
                            <li>Certified Financial Planner <sup>TM</sup>,  CFP<sup>®</sup> คุณวุฒิวิชาชีพนักวางแผนการเงิน จากสมาคมนักวานแผนการเงินไทย</li>
                            ...
                            <li>วิทยากรประจำรายการ “Money Mentor” พี่เลี้ยงพารวย</li>
                            <li>กรรมการผู้จัดการบริษัทฟินคีย์ แอ็ดไวเซอรี่ จำกัด</li>
                            <li>ผู้แนะนำการลงทุนด้านหลักทรัพย์</li>
                            <li>ปรึกษาด้านการบริหารความเสี่ยง</li>
                            <li>ทำงานด้านพัฒนา ติดตั้งและสนับสนุนระบบคอมพิวเตอร์ซอฟต์แวร์ พ.ศ. 2531-2548</li>
                            <br/>
                        </fieldset>
                    </div>
                </div>
...
<div class="modal fade mentor-p_golf" tabindex="-1" role="dialog">
    <div class="tg-signup-modalbox">
        <h2>MENTOR DETAIl <span class="pull-right" style="cursor: pointer" onclick="$('.mentor-p_golf').modal('hide')">x</span></h2>
        <form style="padding:20px" >
            <div>
                <div class="row">
                    <div class="col-sm-4">                                        
                        <img src="assets/images/portfolio/golf_image.png" alt="อ. ณัฏฐพล พราหมณ์สำราญ">
                        <br/><br/>
                        <fieldset>
                            <legend style="text-align: center;border-bottom: 0px !important;">อ.ณัฏฐพล พราหมณ์สำราญ</legend>
                        </fieldset>
                    </div>
                    <div class="col-sm-8" style="overflow-x:hidden; max-height: 450px;">
                        <fieldset>
                            <legend>ประวัติการศึกษา</legend>
                            <li>ปริญญาตรี คณะการบัญชี  มหาวิทยาลัยธุรกิจบัณฑิตย์</li>
                            <li>ใบอนุญาตผู้แนะนำการลงทุนด้านหลักทรัพย์ สำนักงานคณะกรรมการกำกับหลักทรัพย์และตลาดหลักทรัพย์ (กลต)</li>
                            <li>ใบอนุญาตตัวแทนประกันชีวิต สำนักงานคณะกรรมการกำกับและส่งเสริมการประกอบธุรกิจประกันภัย (คปภ.)</li><br/>

                            <legend>ประวัติการเป็นวิทยากร</legend>
                            <li>วิทยากรรับเชิญ เสวนาเรื่อง “วางแผนการเงิน เรื่องที่ควรรู้ก่อนการซื้อบ้าน” ในอภิมหกรรมบ้าน-คอนโดฯและสินเชื่อแห่งปี</li>
                            <li>วิทยากร สัมมนาเชิงปฏิบัติการ “Secret of Money Cat ความลับการจัดการเงินอย่างฉลาด เพื่ออิสรภาพทางการเงิน”</li>
                            <li>วิทยากร สัมมนาเชิงปฏิบัติการ “เคล็ดลับสร้างความมั่งคั่งอย่างยั่งยืน”</li><br/>


                            <legend>ประวัติการทำงาน</legend>
                            <li>ผู้ดำเนินรายการ “Money Mentor” พี่เลี้ยงพารวย</li>
                            <li>กรรมการบริษัทฟินคีย์ แอ็ดไวเซอรี่ จำกัด</li>
                            <li>ผู้แนะนำการลงทุนด้านหลักทรัพย์</li>
                            <li>ที่ปรึกษาด้านการบริหารความเสี่ยง</li>
                            <li>ผู้ช่วยผู้ตรวจสอบบัญชี บริษัท แอ็ดวานซ์ ออดิตติ้ง จำกัด ในเครือ BOL พ.ศ. 2545-2548</li>
                            <br/>
                        </fieldset>
                    </div>
                </div>
